 ...
 * greater number for it in the second array, so output -1. Note: All elements
 * in nums1 and nums2 are unique. The length of both nums1 and nums2 would not
 * exceed 1000.
 * 
 * @author qz
 *
